...
public class Servlet1 extends HttpServlet {
	...
	private int antallBesokSide1 = 0;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("count") != null) {
			...
			getServletContext().setAttribute("antallBesokSide1", antallBesokSide1);
		...
		out.println("Antall besøk side 1 : " + antallBesokSide1);
		out.println("Antall besøk side 2 : " + hentFraContext("antallBesokSide2"));
